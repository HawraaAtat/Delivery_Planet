...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assests/lib/animate/animate.min.css')}}">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    {{-- <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>Delivery Planet</h1> --}}
                    <img src="{{url('/assests/img/logo.png')}}" alt="Logo">
                </a>
