    ...
    <table id="tbOrderHistory" class="table border ps-table w-100 mb-3">
        <thead>
            <tr>
                ...
                <th class="font-weight-bold py-2 border-0 " style="color: #fea116;">New Price</th>
                ...
                <th class="font-weight-bold py-2 border-0 " style="color: #fea116;">Discount</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                @if($rec->new_price)
                <th class="font-weight-bold py-2 border-0 ">${{$rec->new_price}}</th>
                @else
                <th class="font-weight-bold py-2 border-0 "></th>
                @endif
                ...
                <th class="font-weight-bold py-2 border-0 ">
                    ...
                    <form action="{{ route('offer_add.edit', ['offer_add'=>$rec->id] ) }}" class="login-form" method="post">
                        @method('GET')
                        @csrf
                ...
                <th class="font-weight-bold py-2 border-0 ">
                    ...
                    <form action="{{ route('offer_add.destroy', ['offer_add'=>$rec->id] ) }}" class="login-form" method="post">
                        @method('DELETE')
                        @csrf
